...
import { fetchAnimeData } from './modules/api_dorama.js';
import { initMobileMenu, initFilterToggle } from './modules/dom.js';
import { FILTER_CONFIG, applyFilters } from './modules/filters_dorama.js';
import { renderAnimeGrid, showLoadingSkeleton } from './modules/render_dorama.js';
...
function filterByCategory(category) {
  ...
  if (searchStatus) {
    searchStatus.textContent = `Exibindo ${filteredAnimes.length} doramas da categoria "${category}"`;
  }
}
